# Generated by Django 4.1.2 on 2022-11-08 21:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latest_bid', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raiser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='raiser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
